...
<div class="container">
  <form action="issueProcess" method="POST">
    <div class="row">
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="fname" name="pid" placeholder="Item ID">
      </div>
    </div>
    
    <div class="row">
      <div class="col-25">
        <label for="fname">Issuer Name</label>
      </div>
      <div class="col-75">
        <input type="text" id="fname" name="issuer_name" placeholder="Issuer Name">
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input type="date" id="fname" name="datee" placeholder="Date">
      </div>
    </div>
    
    <div class="row" align="left">
      <input type="submit" value="Issue Processed Material">
    </div>
  </form>
  </div>
